...
function DocsController($scope, $http, gdocs) {
  ...
  $scope.uploadBookmarks = function(retry) {
    this.clearDocs();
	...
	function traverseBookmarks(bookmarkTreeNodes) {
		 ...
		 //console.log(bookmarkTreeNodes[i].title, bookmarkTreeNodes[i].url ? bookmarkTreeNodes[i].url : "[Folder]");
		     ...
		     bookmarksList.push(bookmarkTreeNodes[i].url);
		 }
         ...
         // print bookmarksList
	 bookmarksString = bookmarksList.join("\n")
         console.log(bookmarksString)

	 gdocs.upload(bookmarksString, function() {
		 //$scope.fetchDocs(true);
		 document.getElementById("doneTag").innerHtml = "Done uploading";
	 }, true);
    }
  };
